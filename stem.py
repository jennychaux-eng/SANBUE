...
st.set_page_config(
    page_title="STEMher — Plataforma Inteligente para Mujeres STEM",
    page_icon="💜",
    layout="wide",
...
# ── Interview flow ───────────────────────────────────────────────────────────
INTERVIEW_STEPS = [
    {"key": "area", "pregunta": "¡Hola! Soy STEMher AI 💜 Estoy aquí para conocerte de verdad — no solo tu CV. ¿En qué área STEM trabajas o estudias actualmente?", "tipo": "text"},
...
if "Inicio" in p:
    ...
    with col1:
        ...
        <div style='padding: 2rem 0 1rem;'>
            ...
            <p style='color:#6b7280;font-size:1.05rem;max-width:520px;'>STEMher conecta mujeres en ciencia, tecnología, ingeniería y matemáticas con empresas que valoran productividad real, no disponibilidad horaria.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div style='background:linear-gradient(135deg,#7c3aed,#ec4899);border-radius:20px;padding:1.5rem;color:white;margin-top:2rem;'>
            <div style='font-size:1rem;font-weight:600;margin-bottom:1rem;'>¿Por qué STEMher?</div>
...
# ── EMPLEOS ───────────────────────────────────────────────────────────────────
    ...
    empleos = [
        {"empresa": "TechCorp Latam", "rol": "Data Scientist Senior", "compatibilidad": 94, "modalidad": "Remoto", "horario": "Flexible", "area": "Ciencia de Datos", "salario": "$4,500–6,000 USD/mes", "tags": ["Python", "ML", "Spark"], "descripcion": "Equipo 100% femenino en liderazgo. Horarios asíncronos. Resultados sobre horas."},
        ...
        {"empresa": "InnovaData", "rol": "ML Engineer", "compatibilidad": 82, "modalidad": "Remoto", "horario": "20h/semana", "area": "Ciencia de Datos", "salario": "$2,800–3,500 USD/mes", "tags": ["TensorFlow", "Python", "AWS"], "descripcion": "Rol part-time. Ideal para mujeres con responsabilidades adicionales."},
        {"empresa": "Universidad Nacional", "rol": "Investigadora Postdoctoral STEM", "compatibilidad": 76, "modalidad": "Presencial", "horario": "Horario flexible", "area": "Investigación", "salario": "$2,000–2,500 USD/mes", "tags": ["R", "Estadística", "Publicaciones"], "descripcion": "Grupo de investigación comprometido con equidad de género."},
        {"empresa": "StartupX", "rol": "Full Stack Developer", "compatibilidad": 71, "modalidad": "Remoto", "horario": "Resultados, no horas", "area": "Desarrollo Web", "salario": "$3,000–4,000 USD/mes", "tags": ["React", "Node.js", "PostgreSQL"], "descripcion": "Startup en crecimiento. Cultura asíncrona y enfocada en impacto."},
    ]

    # Filter
    col1, col2 = st.columns([2, 1])
    with col1:
        filtro_area = st.selectbox("Filtrar por área", ["Todas"] + list(set(e["area"] for e in empleos)))
    with col2:
...
# ── COMUNIDAD ─────────────────────────────────────────────────────────────────
    ...
    # Spaces
    areas = ["Todas", "Ciencia de Datos", "Ingeniería de Software", "Electrónica", "Investigación", "Mecánica", "Emprendimiento", "Ingeniería Biomédica"]
...
# ── EVENTOS ───────────────────────────────────────────────────────────────────
    ...
    st.markdown("<div class='section-header'>📅 Eventos STEM Connect</div>", unsafe_allow_html=True)
    ...
    <div class='card-purple'>
        ...
        <div style='font-size:1.8rem;font-weight:800;margin:0.3rem 0;'>STEMher Summit 2025</div>
...
# ── MENTORÍAS ────────────────────────────────────────────────────────────────
    ...
    area_m = st.selectbox("Tu área", ["Ciencia de Datos", "Ingeniería de Software", "Electrónica", "Investigación", "Liderazgo", "Emprendimiento", "Otro"])
